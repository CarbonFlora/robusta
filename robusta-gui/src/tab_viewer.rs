...
// use crate::ui::gizmo::draw_gizmo;
use crate::uistate::InspectorSelection;
...
impl egui_dock::TabViewer for TabViewer<'_> {
    //what's the relationship between TabViewer and EguiWindow?
    type Tab = EguiWindow;
    ...
    fn clear_background(&self, window: &Self::Tab) -> bool {
        !matches!(window, EguiWindow::Viewport)
    }
}
